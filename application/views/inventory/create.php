    ...
    <div class="col-lg-10">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white p-4 border-bottom-0 d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="fw-bold text-dark mb-1">Tambah Data Aset Baru</h5>
                    <p class="text-muted small mb-0">Isi formulir di bawah ini untuk menambahkan aset ke dalam sistem.</p>
                </div>
            ...
            <div class="card-body p-4 pt-0">
                <form action="<?php echo base_url('tambah'); ?>" method="POST" hx-boost="false">
                    <div class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="name" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;" required autocomplete="off" placeholder="misal: MacBook Pro M2 14 Inch">
                        </div>
                        <div class="col-md-6">
                            <label class="fw-medium text-secondary small mb-2">ID Barcode</label>
                            <input type="text" name="barcode_id" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;" autocomplete="off" placeholder="misal: BC-00123">
                            <div class="form-text small text-muted fst-italic">Kosongkan jika auto-generate.</div>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-medium text-secondary small mb-2">Serial Number <span class="text-danger">*</span></label>
                            <input type="text" name="serial_number" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;" required autocomplete="off" placeholder="misal: C02G1234MD6R">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="lokasi_id" id="id_lokasi" placeholder="Pilih Lokasi...">
                                ...
                                <?php foreach ($lokasiList as $loc): ?>
                                    <option value="<?php echo $loc->id; ?>"><?php echo htmlspecialchars($loc->nama); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="purchase_date" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group shadow-sm" style="border-radius: 0.5rem; overflow: hidden;">
                                ...
                                <input type="text" id="price_display" class="form-control bg-white border-start-0" style="padding: 0.7rem 1rem;" placeholder="0" autocomplete="off">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 border">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="current_user" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;" placeholder="Nama karyawan pengguna aktif">
                                </div>
                                <div>
                                    <label class="text-muted small mb-1">Departemen</label>
                                    <input type="text" name="current_dept" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;" placeholder="Divisi / Dept user saat ini">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 border">
                                <label class="fw-bold text-dark small mb-2 d-block">User Sebelumnya (Opsional)</label>
                                <div class="mb-3">
                                    <label class="text-muted small mb-1">Nama User Lama</label>
                                    <input type="text" name="prev_user" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;" placeholder="Nama pemakai sebelumnya">
                                </div>
                                <div>
                                    <label class="text-muted small mb-1">Departemen Lama</label>
                                    <input type="text" name="prev_dept" class="form-control bg-white shadow-sm" style="padding: 0.7rem 1rem;" placeholder="Divisi pemakai sebelumnya">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <textarea name="note" class="form-control bg-white shadow-sm" rows="3" style="padding: 0.7rem 1rem;" placeholder="Catatan fisik, kondisi khusus, atau aksesoris tambahan..."></textarea>
                        </div>
                    </div>
