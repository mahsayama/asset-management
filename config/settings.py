...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['http://34.101.154.14:8080']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Pastikan folder templates lu kedetek disini
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
                'django.template.context_processors.request', # INI YG TADI HILANG
                'django.contrib.auth.context_processors.auth', # INI YG TADI HILANG
                'django.contrib.messages.context_processors.messages', # INI YG TADI HILANG
            ],
        },
    },
]
